...
import com.avi.firebase.databinding.ActivityPhoneBinding
...
class PhoneActivity : AppCompatActivity() {
    ...
    fun signinWithSMSCode(){
        ...
        signinWithPhoneAuthProviderCredential(credential)
    }

    fun signinWithPhoneAuthProviderCredential(credential: PhoneAuthCredential){
